// Canvas — landscape on all platforms (mobile uses gamepad overlay)
export const W = 800;
export const H = 500;
...
export const WAVES = [
  ...
  },
  {
    ...
    spawnInterval: 460,
    minInterval: 280,
    obstacles: { ultraball: 3, masterball: 2, zubat: 2, geodude: 2, gastly: 2, pidgey: 2, ember: 1 },
    berryChance: 0.15,
    eventsEnabled: true,
  },
  {
    ...
    spawnInterval: 420,
    minInterval: 260,
    obstacles: { ultraball: 2, masterball: 2, zubat: 2, geodude: 3, gastly: 2, pidgey: 2, ember: 2, watergun: 1 },
    berryChance: 0.16,
    eventsEnabled: true,
  },
  {
    ...
    spawnInterval: 380,
    minInterval: 240,
    obstacles: { masterball: 3, zubat: 2, geodude: 3, gastly: 2, pidgey: 2, ember: 2, watergun: 2, vinewhip: 1 },
    berryChance: 0.17,
    eventsEnabled: true,
  },
  {
    ...
    spawnInterval: 340,
    minInterval: 220,
    obstacles: { masterball: 3, geodude: 3, gastly: 2, pidgey: 3, ember: 3, watergun: 2, vinewhip: 2 },
    berryChance: 0.18,
    eventsEnabled: true,
  },
  {
    ...
    spawnInterval: 300,
    minInterval: 200,
    obstacles: { masterball: 4, geodude: 3, gastly: 2, pidgey: 3, ember: 3, watergun: 3, vinewhip: 3 },
    berryChance: 0.20,
    eventsEnabled: true,
  },
];
